...
var base_dir = path.join(path.resolve('.'), 'tests');
...
function processFiles() {
    ...
    var base = name;
    var info = require(path.join(base_dir, name, 'info.json'));
    ...
    function processFileTest() {
        ...
        var key = keys.shift();
        var actual = path.join(base_dir, name, key, 'actual.png');
        var expected = path.join(base_dir, name, key, 'expected.png');
        var diff = path.join(base_dir, name, key, 'diff.png');
...
function done() {
    ...
    var p = path.join(path.resolve('.'), 'tests', 'index.html');
